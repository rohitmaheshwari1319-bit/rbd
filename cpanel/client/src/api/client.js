// Tiny fetch wrapper for the cPanel API. Adds the bearer token automatically
// and lifts JSON, throwing on non-2xx with a useful Error.
const BASE = '/api';
const TOKEN_KEY = 'cpanel.token';
