      ...
      <div className="fixed top-4 right-4 z-[9999] flex flex-col gap-2 w-80 max-w-[calc(100vw-2rem)]">
        {toasts.map(t => {
          ...
          const tone = {
            ...
            error: 'bg-rbd-50 text-rbd-700 ring-rbd-200 dark:bg-rbd-900/30 dark:text-rbd-100 dark:ring-rbd-900',
          ...
          return (
            <div key={t.id}
                 className={`animate-fade-in shadow-card rounded-xl px-3 py-2.5 flex gap-2 items-start ring-1 ${tone}`}>
